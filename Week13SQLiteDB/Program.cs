...
static void ReadData(SQLiteConnection myConnection )
{
    ...
    while (reader.Read())
    {
        ...
        Console.WriteLine($"{readerRowId}. Fulle name: {readerStringFirstName} {readerStringLastName}; Dob: {readerStringDob}");
    }
...
static void FindCustomer(SQLiteConnection myConnection)
{
    ...
    command = myConnection.CreateCommand();
    command.CommandText = $@"
        SELECT customer.rowid, customer.firstname, customer.lastname, status.statusName 
        FROM customerStatus 
